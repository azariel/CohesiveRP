                ...
                foreach (var characterSheetInstancesObj in characterSheetInstancesObjs)
                {
                    ...
                    foreach (var instance in matchingInstances)
                    {
                        instance.CharacterSheet = new CharacterSheet
                        {
                            ...
                            AreolasColor = dbModel.CharacterSheet.AreolasColor,
                            ...
                            TeethDetails = dbModel.CharacterSheet.TeethDetails,
                            NailsColor = dbModel.CharacterSheet.NailsColor,
                            NailsDetails = dbModel.CharacterSheet.NailsDetails,
                            Eyebrows = dbModel.CharacterSheet.Eyebrows,
                            LipsDetails = dbModel.CharacterSheet.LipsDetails,
