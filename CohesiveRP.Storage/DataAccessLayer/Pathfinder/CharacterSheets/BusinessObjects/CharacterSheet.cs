...
namespace CohesiveRP.Storage.DataAccessLayer.Pathfinder.ChatCharactersRolls.BusinessObjects
{
    public class CharacterSheet
    {
        ...
        public string FirstName { get; set; }// Daphne

        [JsonPropertyName("lastName")]
        public string LastName { get; set; }// Greengrass

        [JsonPropertyName("birthdayDate")]
        public DateTime? BirthdayDate { get; set; }// 27 March 1980

        [JsonPropertyName("gender")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public Gender? Gender { get; set; }// Female

        [JsonPropertyName("ageGroup")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public AgeGroup? AgeGroup { get; set; }// Young adult

        [JsonPropertyName("race")]
        public string Race { get; set; }// human, elf, ... + add blood purity (mixed, pureblood, etc) // human (Pure-blood witch)

        [JsonPropertyName("height")]
        public string Height { get; set; }// five foot four (162 cm)

        [JsonPropertyName("speechPattern")]
        public string SpeechPattern { get; set; }// feminine and low, controlled and detached. Conveys subtle authority through dry wit and intelligent sarcasm. Her tone is cold(icy) with people she dislikes. Her voice can turn into venom when annoyed. Daphne rarely raises her voice, preferring cold and detached tone over emotional outbursts.

        [JsonPropertyName("speechImpairment")]
        public string SpeechImpairment { get; set; }// could be something like stutters, crippling shyness, etc

        [JsonPropertyName("bodyType")]
        public string BodyType { get; set; }// lean and slender with attractive feminine aristocratic features

        [JsonPropertyName("hairColor")]
        public string HairColor { get; set; }// platinum blonde

        [JsonPropertyName("hairStyle")]
        public string HairStyle { get; set; }// long, straight, slicked back

        [JsonPropertyName("eyeColor")]
        public string EyeColor { get; set; }// emerald green

        [JsonPropertyName("earShape")]
        public string EarShape { get; set; }// normal // in fantasy scenario, pointy seems like a reasonable choice

        [JsonPropertyName("skinColor")]
        public string SkinColor { get; set; }// very pale

        [JsonPropertyName("genitals")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public Genitals? Genitals { get; set; }// female

        [JsonPropertyName("breastsSize")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public BreastsSize? BreastsSize { get; set; }// small

        [JsonPropertyName("sexuality")]
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public SexualityOrientation? Sexuality { get; set; }// bisexual
        ...
        public string Profession { get; set; }// Hogwarts student (Slytherin House)

        [JsonPropertyName("reputation")]
        public string Reputation { get; set; }// Daphne has the reputation of the 'Ice Princess' of Slytherin due to her cold demeanor and acid remarks to people she doesn't like. She is known to be discreet and independant. She is ostracised from other Slytherin students due to her cold attitude

        [JsonPropertyName("preferredCombatStyle")]
        public string PreferredCombatStyle { get; set; }// She often open the fight using darker curses that leave long-lasting or permanent marks on her opponent (cutting curses are her favorite. She also uses banishing charms, binding charms(ropes) and environmental charms(create some ice under her opponent's feet to make them trip) to get control over her enemy. She is wary of being hurt and will quickly shift on defense when overwhelmed.

        [JsonPropertyName("weaponsProficiency")]
        public string WeaponsProficiency { get; set; }// wand magic

        [JsonPropertyName("combatAffinityAttack")]
        public string CombatAffinityAttack { get; set; }// Medium-High (uses stupefy, binding enemy's body with magical ropes, transfiguration to bind her opponent's body, stinging jinx, trip jinx, Jelly-Legs Jinx, Reducto curse, Laceration Curse, Leg-Locker Curse, etc. Daphne will use unforgivable when her life is threatened)

        [JsonPropertyName("combatAffinityDefense")]
        public string CombatAffinityDefense { get; set; }// Medium (uses shield charm, but focus more on controlling her opponent body with magical ropes, shackles, binds, vines or using stupefaction spells)

        [JsonPropertyName("socialAnxiety")]
        public string SocialAnxiety { get; set; }// None // could be shy

        [JsonPropertyName("clothesPreference")]
        public string ClothesPreference { get; set; }// Impeccably tailored expensive silk Hogwarts robes that emphasize her aristocratic traits. Always perfectly groomed and accessorized, favoring elegant clothes that speak of old money and taste. Frequently wears very expensive perfume. She prefers lace silk bras and panties.

        [JsonPropertyName("mannerisms")]
        public string Mannerisms { get; set; }// Carries herself like a queen in exile, one hand often resting on hip bones. Movements are graceful and controlled, every gesture deliberate and self-conscious. Maintains perfect posture that conveys both distance and authority.

        [JsonPropertyName("behavior")]
        public string Behavior { get; set; }// Composed, intelligent, and quietly ambitious. Harbors an unflinching stoic mask of indifference to hide any vulnerabilities. Values control, subtlety, and loyalty, preferring influence through genuine alliances rather than superficial ones. Raised with pure-blood traditions, yet guided more by pragmatism than prejudice. Her care runs deep, but is expressed through quiet acts rather than words. Lash-out sarcasm when cornered. Daphne is very protective of her friends and of her younger sister Astoria. Daphne drops some part of her mask of indifference when alone with her friends.

        [JsonPropertyName("attractiveness")]
        public string Attractiveness { get; set; }// Very High (She's seen a skinny and petite aristocratic beauty, but inaccessible due to her personality)

        [JsonPropertyName("kinks")]
        public string[] Kinks { get; set; }// ex: Body Worship & Inspection (RECEIVE): A partner meticulously admiring and caressing every inch of her body, including her small breasts and the scar on her ribs. This transforms her perceived flaws into objects of desire, directly healing her deep-seated self-consciousness.

        [JsonPropertyName("secretKinks")]
        public string[] SecretKinks { get; set; }// ex: Pet Play & Collaring others (GIVE): Treating her partner or victim as a pet. Collaring them, leashing them, making them eat from a bowl, sleep at her feet, washing them herself and forcing them to walk behind her (either publicly collared and leashed or not). This allows her to enjoy the total control she has over another human being, enhancing the perception of her own superiority.

        [JsonPropertyName("skills")]
        public string[] Skills { get; set; }// ex: Competent duelist with elegant and precise spellwork based on her opponent body control

        [JsonPropertyName("weaknesses")]
        public string[] Weaknesses { get; set; }// ex: Unwillingness to directly escalate a conflict to a magical or physical fight. She will often simply descalate the argument instead.

        [JsonPropertyName("fears")]
        public string[] Fears { get; set; }// ex: She's secretly terrified that the blood malediction affecting her family manifests in herself

        [JsonPropertyName("likes")]
        public string[] Likes { get; set; }// ex: The feeling of complete control over a situation or a person

        [JsonPropertyName("dislikes")]
        public string[] Dislikes { get; set; }// ex: Chaos and unpredictability in any form

        [JsonPropertyName("secrets")]
        public string[] Secrets { get; set; }// ex: The Greengrass blood malediction that has manifested in her sister Astoria

        [JsonPropertyName("personalityTraits")]
        public string[] PersonalityTraits { get; set; }// ex: Composed, Intelligent, Quietly ambitious, Graceful, ...

        [JsonPropertyName("goalsForNextYear")]
        public string[] GoalsForNextYear { get; set; }// ex: Daphne wants to find contractual loopholes or coercive evidence to legally or politically nullify the betrothal to Draco Malfoy.

        [JsonPropertyName("longTermGoals")]
        public string[] LongTermGoals { get; set; }// ex: Daphne wants to recruits a loyal informant, healer, and a political figure bound to her by mutual benefit and quiet favors.

        [JsonPropertyName("pathfinderAttributes")]
        public PathfinderAttribute[] PathfinderAttributesValues { get; set; } = [
            // Default to AVERAGE human male attributes AKA 10 everywhere
