...
namespace CohesiveRP.Core.PromptContext.Builders.Directive
{
    public class PromptContextSummaryExtraTermBuilder : IPromptContextElementBuilder
    {
        ...
        public PromptContextSummaryExtraTermBuilder(IStorageService storageService, PromptContextFormatElement promptContextFormatElement, GlobalSettingsDbModel settings, ChatDbModel chatDbModel, PersonaDbModel personaLinkedToChat, CharacterDbModel[] charactersLinkedToChat)
        {
        ...
        public async Task<(string, IShareableContextLink)> BuildAsync()
        {
            ...
            foreach (ISummaryEntryDbModel summaryElement in summaryDbModel.ExtraTermSummaries.Where(w => !string.IsNullOrWhiteSpace(w.Content)))
            {
