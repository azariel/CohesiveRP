...
namespace CohesiveRP.Core.PromptContext.Builders.Directive
{
    public class PromptContextSummaryMediumTermBuilder : IPromptContextElementBuilder
    {
        ...
        public PromptContextSummaryMediumTermBuilder(IStorageService storageService, PromptContextFormatElement promptContextFormatElement, GlobalSettingsDbModel settings, ChatDbModel chatDbModel)
        {
        ...
        public async Task<(string, IShareableContextLink)> BuildAsync()
        {
            ...
            string output = $"# Previous facts, events, speech and actions (Medium-Term){Environment.NewLine}";
