...
{
    public class PromptContextNarrativeDirectionInstructionsBuilder : IPromptContextElementBuilder
    {
        ...
        public PromptContextNarrativeDirectionInstructionsBuilder(IStorageService storageService, PromptContextFormatElement promptContextFormatElement, ChatDbModel chatDbModel, string linkedMessageId, PersonaDbModel personaLinkedToChat, CharacterDbModel[] charactersLinkedToChat)
        {
