    ...
    public class PromptContextElementBuilderFactory : IPromptContextElementBuilderFactory
    {
        ...
        public async Task<IPromptContextElementBuilder> GenerateBuilderAsync(PromptContextFormatElement contextElement, GlobalSettingsDbModel settings, ChatDbModel chatDbModel, BackgroundQueryDbModel backgroundQuery, BackgroundQuerySystemTags tag, PersonaDbModel personaLinkedToChat, CharacterDbModel[] charactersLinkedToChat)
        {
            ...
            switch (contextElement.Tag)
            {
                ...
                case PromptContextFormatTag.NarrativeDirectionInstructions:
                    return new PromptContextNarrativeDirectionInstructionsBuilder(storageService, contextElement, chatDbModel, backgroundQuery?.LinkedId, personaLinkedToChat, charactersLinkedToChat);
                case PromptContextFormatTag.ProseGuardianInstructions:
                ...
                case PromptContextFormatTag.CohesionEnforcerWriter:
                    return new CohesionEnforcerWriterBuilder(storageService, contextElement, chatDbModel, personaLinkedToChat, charactersLinkedToChat);
                default:
