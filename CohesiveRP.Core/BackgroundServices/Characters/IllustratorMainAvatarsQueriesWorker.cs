                ...
                foreach (string sourceAvatarFilePath in sourceAvatarFilePaths)
                {
                    try
                    {
                        ...
                        string workflowJson = new ExpressionWorkflowInjector(templateJson).Inject(new AvatarGenerationRequest
                        {
                            ...
                            PositivePrompt = $"score_9,masterpiece,best quality,amazing quality,score_8_up,score_7_up,{genderedTags},solo,upper body,facing viewer,looking at viewer,standing,straight-on,{Environment.NewLine}{outfit.IllustratorPromptInjection}{Environment.NewLine}{positiveExpressionTags},good head proportions,black background,simple background,detailed face,beautiful eyes",
