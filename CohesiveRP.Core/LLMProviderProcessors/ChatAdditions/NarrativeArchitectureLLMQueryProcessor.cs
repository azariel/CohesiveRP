...
{
    public class NarrativeArchitectureLLMQueryProcessor : LLMQueryProcessor
    {
        public NarrativeArchitectureLLMQueryProcessor(
        ...
        public override async Task<bool> ProcessCompletedQueryAsync()
        {
            ...
            {
                LoggingManager.LogToFile("58a5fff1-56e7-48ea-ac46-9e5ca33751c7", $"Couldn't complete backgroundTask [{backgroundQueryDbModel.BackgroundQueryId}]. Task will be set to Pending status for re-generation.", e);
                backgroundQueryDbModel.Content = null;
